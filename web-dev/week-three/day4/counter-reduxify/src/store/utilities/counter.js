...
// REDUCER FUNCTION;
// Part of the reason why we have to return a default value for our switch statement is because combineReducers will go into our object of reducer, and invoke all reducer functions to address the incoming action object --- without a default statement, we would return undefined --- which would replace the state of that value to be undefined;
//The other reason for having a default statement is that when an action is sent to the store, all connected components will fire off their something along the lines of (pseudocode incoming) Redux.Store.GetState() --- and that should at least have the value of the most up to date state.
