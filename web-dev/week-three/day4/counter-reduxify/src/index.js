...
import store from "./store"; //if the file you are importing is the "index.js" of a directory, you can just use the directory name because the index.js is impleid;
